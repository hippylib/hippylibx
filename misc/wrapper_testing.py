...
Rsolver.solve(dlx.la.create_petsc_vector_wrap(vec1) , dlx.la.create_petsc_vector_wrap(vec2_with_wrapper)) #works
Rsolver_org.solve(  dlx.la.create_petsc_vector_wrap(vec2_without_wrapper) , dlx.la.create_petsc_vector_wrap(vec1)  )
