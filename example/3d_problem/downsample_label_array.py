...
def label_maker(label_array: np.array, f:float )-> Tuple[np.array, np.array, np.array, np.array]:
    ...
    reduced_labels = zoom(tight_label,(scale,scale,scale))
...
np.save('i_range_factor_8',i_range)
np.save('j_range_factor_8',j_range)
np.save('k_range_factor_8',k_range)
np.save('reduced_labels_factor_8_colab',reduced_labels)