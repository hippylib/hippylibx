...
def run_inversion(mesh_filename: str, nx : int, ny : int, noise_variance : float, prior_param : dict) -> None:
    ...
    with dlx.io.VTXWriter(msh.comm, "qpact_Variational_Regularization_prior_np{0:d}_Prior.bp".format(nproc), [m_fun, m_true_fun, u_map_fun, u_true_fun, d_fun] ) as vtx:
        vtx.write(0.0)
